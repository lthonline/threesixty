	...
	return (
		<div className="threesixty-icon-heading">
			...
			<RichText
				...
				placeholder={ __( 'Heading…', 'threesixty' ) } // Display this text before any content has been added by the user
			/>
			<InspectorControls>
				<PanelBody title={ __( 'Block Settings', 'threesixty' ) }>
					<RadioControl
						label={ __( 'Select the icon', 'threesixty' ) }
						help={ __( 'Controls icon selection', 'threesixty' ) }
						selected={ option }
						options={ [
							{ label: 'Dos', value: 'dos' },
