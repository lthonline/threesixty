...
<!-- wp:cover {"url":"<?php echo esc_url( THREESIXTY_BUILD_IMG_URI . '/patterns/cover.jpg' ) ?>","id":3854,"minHeight":640,"align":"full","className":"threesixty-cover"} -->
<div class="wp-block-cover alignfull has-background-dim threesixty-cover" style="background-image:url(<?php echo esc_url( THREESIXTY_BUILD_IMG_URI . '/patterns/cover.jpg' ) ?>);min-height:640px"><div class="wp-block-cover__inner-container"><!-- wp:heading {"align":"center","level":1} -->
