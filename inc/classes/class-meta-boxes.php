...
class Meta_Boxes {
	...
	public function add_custom_meta_box() {
		...
		foreach ( $screens as $screen ) {
			add_meta_box(
				...
				__( 'Hide page title', 'threesixty' ),  // Box title
	...
	public function custom_meta_box_html( $post ) {
		...
		?>
		<label for="threesixty-field"><?php esc_html_e( 'Hide the page title', 'threesixty' ); ?></label>
		<select name="threesixty_hide_title_field" id="threesixty-field" class="postbox">
			<option value=""><?php esc_html_e( 'Select', 'threesixty' ); ?></option>
			<option value="yes" <?php selected( $value, 'yes' ); ?>>
				<?php esc_html_e( 'Yes', 'threesixty' ); ?>
			</option>
			<option value="no" <?php selected( $value, 'no' ); ?>>
				<?php esc_html_e( 'No', 'threesixty' ); ?>
			</option>
		</select>
		<?php
	}
	...
	public function save_post_meta_data( $post_id ) {
		...
		if ( array_key_exists( 'threesixty_hide_title_field', $_POST ) ) {
			update_post_meta(
				$post_id,
				'_hide_page_title',
				$_POST['threesixty_hide_title_field']
			);
		}
	}
